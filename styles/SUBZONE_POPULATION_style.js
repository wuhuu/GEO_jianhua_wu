var size = 0;
var ranges_SUBZONE_POPULATION = [[0.000000, 6910.000000, [ new ol.style.Style({
...
var styleCache_SUBZONE_POPULATION={}
var style_SUBZONE_POPULATION = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    var value = feature.get("AgeGroup2016_ALL_AGE");
    var style = ranges_SUBZONE_POPULATION[0][2];
    for (i = 0; i < ranges_SUBZONE_POPULATION.length; i++){
        var range = ranges_SUBZONE_POPULATION[i];
    ...
    if (!styleCache_SUBZONE_POPULATION[key]){
        ...
        styleCache_SUBZONE_POPULATION[key] = new ol.style.Style({"text": text})
    }
    var allStyles = [styleCache_SUBZONE_POPULATION[key]];
